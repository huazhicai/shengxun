...
# @retry(attempt=6)
def greurl(conn=None, instable=None, insname=None, cityn=None, urlafter=None, gredurl=None, pagenum=None):
    if gredurl == 1:
        ...
        pass
    urlbf = conn.execute('''SELECT * FROM baseurls''')
        ...
        try:
            ...
            if not exnames or not exphones:
                ...
                if inc_link.find('/mq/') == -1:
                    try:
                        faren = stringclean(json.dumps(ntree.xpath('//*/div[@class="basicMsg"]/ul/li[3]/text()')[0],
                                                       ensure_ascii=False))
                    except Exception as e:
                        logging.debug("%s" % str(e))
                        pass
                    try:
                        inclianxi = stringclean(json.dumps(ntree.xpath('//*/div[@class="basicMsg"]/ul/li[2]/text()')[0],
                                                           ensure_ascii=False))
                    except Exception as e:
                        raise e
                    try:
                        incxingzhi = stringclean(
                                json.dumps(ntree.xpath('//*/div[@class="basicMsg"]/ul/li[5]/text()')[0],
                                           ensure_ascii=False))
                    except Exception as e:
                        logging.debug("%s" % str(e))
                        pass
                    try:
                        guimo = stringclean(json.dumps(ntree.xpath('//*/div[@class="basicMsg"]/ul/li[7]/text()')[0],
                                                       ensure_ascii=False))
                    except Exception as e:
                        logging.debug("%s" % str(e))
                        pass
                    try:
                        dizhi = stringclean(json.dumps(ntree.xpath(
                        ...
                        pass
                    try:
                        hangye = stringclean(json.dumps(
                                ntree.xpath('//*/div[@class="basicMsg"]/ul/li[9]/div[@class="tradeName"]/a/text()')[0],
                                ensure_ascii=False))
                    ...
                    try:
                        ...
                        pass
                    try:
                        incjianjie = stringclean(json.dumps(ntree.xpath(
                    ...
                    try:
                        ...
                        pass
                    try:
                        inclianxi = stringclean(json.dumps(ntree.xpath(
                    ...
                    try:
                        ...
                        pass
                    try:
                        incxingzhi = stringclean(json.dumps(ntree.xpath(
                        ...
                        pass
                    try:
                        guimo = stringclean(json.dumps(ntree.xpath(
                    ...
                    try:
                        ...
                        pass
                    try:
                        hangye = stringclean(json.dumps(ntree.xpath(
                ...
                try:
                    phoneno = stringclean(
                            json.dumps(ptree.xpath("//*/div[@class='ffield']/a[@id='contact_phone']/@phoneno")[0],
                                       ensure_ascii=False))
                ...
                try:
                    ...
                    pass
                try:
                    zplianxi = stringclean(json.dumps(
                            ptree.xpath(
                    ...
                    pass
                try:
                    zhiwei = stringclean(json.dumps(
                            ptree.xpath("//*/section[@class='job_con']/ul/li[1]/span[@class='attrValue']/a/text()")[0],
                            ensure_ascii=False))
                except Exception as e:
                    logging.debug("%s" % str(e))
                    pass
                try:
                    yaoqiu = stringclean(json.dumps(ptree.xpath(
                            "//*/section[@class='job_con']/ul/li[@class='req']/span[@class='attrValue']/text()")[0],
                                                    ensure_ascii=False))
                except Exception as e:
                    logging.debug("%s" % str(e))
                    pass
                try:
                    xinzi = stringclean(json.dumps(ptree.xpath(
                    ...
                    pass
                try:
                    fuli = stringclean(json.dumps(ptree.xpath(
                ...
                if not exphones:
                    ...
                    timeoutupdate(conn, instable, insname, city, ciqu, quyu1, inc_name1, link1, faren, inclianxi,
                                  incxingzhi,
                                  guimo,
                                  dizhi, hangye, jingdu, weidu, incjianjie, phoneno, zplianxi, zhiwei, yaoqiu, xinzi,
                                  fuli)
                else:
                    addtimes = addtimes + 1
